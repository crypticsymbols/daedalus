...
var getControlInputPlane = function(attitudeInputs){
  ...
  return [
    ...
    {x: 0, y: 1, z: attitudeInputs.yR}, // one point represents pitch by changing Z at X=0, Y=1
    {x: 1, y: 0, z: attitudeInputs.xR} // last point represents roll by changing Z at X=1, Y=0
  ]
}
