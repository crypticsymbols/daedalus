module.exports = function ModeHandler(vehicleConfig, controlFunction, vehicleState) {
  //
  ...
  // mode getter
  this.getMode = () => {
    return this.modes[currentMode.name]
  }
  ...
  this.initializeAfterModeSwitch = () => {
    var newCurrentMode = this.getMode()
    var controlState = vState.getControlState()
    newCurrentMode(controlState)
  }
